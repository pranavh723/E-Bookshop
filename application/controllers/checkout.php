...
class Checkout extends CI_Controller {
        ...
        public function index()
        {
                ...
                else
                {
                        ...
                        $payment_method = $this->input->post('paymentcheck');

                        if($payment_method == 'Online') {
                            // Integration logic for Razorpay/Stripe would go here.
                            // For now, we simulate a successful redirect or processing.
                            // In a real scenario, you'd load a library and call its charge method.
                        }
